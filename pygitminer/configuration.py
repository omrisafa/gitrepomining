...
# This class holds all the possible configurations of the mining process 
class Conf:
    ...
    def __init__(self, options):
        ...
        self._check_repos(self.get('path_to_repo'))
